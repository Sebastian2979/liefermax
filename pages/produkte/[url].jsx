...
export default function ProduktSeite({ produkt }) {
    ...
    if(!produkt){
        return(<div><h2>keine Produkte gefunden!</h2></div>)
    }
    ...
    return (
        ...
        >
            <div>
                <Link href='/'>
                    <div className='text-dark'>zurück zur Übersicht</div>
                </Link>
            </div>
            <div className='row row-cols-2 mt-2'>
                ...
                <div>
                    ...
                    <ListGroup variant='flush'>
                        <ListGroupItem>
                            <h2 className='text-danger'>{preis.toFixed(2)} EUR</h2>
                        </ListGroupItem>
                        <ListGroupItem>
                        ...
                        <ListGroupItem>
                            ...
                            {produkt.extras.map((extra) => (
                                <span key={extra._id}>
                                    {extra.text} <input className='form-check-input me-2' type='checkbox' id={extra.text} onChange={(e) => addExtra(e, extra)}/>
                                </span>
                            ))}
                        </ListGroupItem>
                        <ListGroupItem>
